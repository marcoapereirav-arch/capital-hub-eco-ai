...
-- Seguridad Capital Hub: super_admin all, equipo lectura, alumnos CERO.
DROP POLICY IF EXISTS "admin_all_folders" ON knowledge_folders;
DROP POLICY IF EXISTS "auth_read_folders" ON knowledge_folders;
DROP POLICY IF EXISTS "kf_admin_all" ON knowledge_folders;
CREATE POLICY "kf_admin_all" ON knowledge_folders FOR ALL TO public
...
DROP POLICY IF EXISTS "kf_team_read" ON knowledge_folders;
CREATE POLICY "kf_team_read" ON knowledge_folders FOR SELECT TO authenticated
