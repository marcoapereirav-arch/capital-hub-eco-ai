...
|---|---|---|---|---|
| 🟢 | `agenda_to_calendar` | POST `/api/calendar/book` | Cuando alguien reserva en `/agenda` | Pega evento en Google Calendar de Adrián. Requiere `calendar_owners.google_oauth_refresh_token` |
