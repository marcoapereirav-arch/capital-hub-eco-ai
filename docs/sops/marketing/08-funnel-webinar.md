...
- **2026-07-30 (v5) — Rediseño de la landing (feedback Marco, referencia `live.mkthackers.com/mkt-hackers-optin-d`).**
  ...
  - **2026-07-31 · Revisión adversarial (19 agentes) sobre la pasada de UI/UX.** 8 hallazgos confirmados y corregidos. Los dos que importaban:
    ...
    - **"Plazas limitadas" seguía en el pie del formulario**, y la REGLA #12 del Knowledge lo prohíbe con esa frase literal. Venía de una limpieza incompleta del 2026-07-29 (se quitó "sin compromiso" y se dejó su hermana). Cambiado a *"Es gratis y es en directo."*
