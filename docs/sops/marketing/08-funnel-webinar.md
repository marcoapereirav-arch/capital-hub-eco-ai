...
- **2026-07-30 (v5) — Rediseño de la landing (feedback Marco, referencia `live.mkthackers.com/mkt-hackers-optin-d`).**
  ...
  - **El dato de mercado es una PIEZA VISUAL, no un párrafo.** Marco, tras varias pasadas: *"veo demasiadas líneas de texto... la parte donde dice fuente informe estado bla bla bla se ven tres líneas"*. Antes el dato vivía dentro de la frase y la fuente ocupaba 3 líneas en móvil. Ahora:
