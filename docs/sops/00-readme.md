...
- **2026-07-24**: Formación **IA Integrator** rehecha. El contenido anterior (3 manuales de Vibe Coding y Git heredados de NVISION) se retira entero por indicación de Marco y se sustituye por sus **tres entrenamientos**: cómo funciona todo, cómo usar el sistema y trabajar en equipo. Las tres páginas visuales quedan construidas y abiertas en `/formacion/ia-integrator` (antes solo existía la primera). Nace el kit visual compartido (`formacion-kit.tsx`) y la skill **`formacion-visual`**, que fija el diseño para toda página de formación futura. Ver [`producto/ia-integrator`](producto/ia-integrator/00-readme.md).
