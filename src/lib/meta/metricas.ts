...
export type Metrica = {
  ...
  forma: FormaValor
  /**
   * Familia de variantes. Meta ofrece VARIAS versiones de la misma idea (ocho CTR
   * distintos, seis formas de contar clics). Esto las agrupa para poder enseñarlas
   * juntas y explicar en qué se diferencian, en vez de soltar 47 nombres sueltos.
   */
  base: string
...
export const METRICAS: readonly Metrica[] = [
  ...
  // ── GASTO ──
  {
    id: "spend", base: "Gasto", nombre: "Gasto", explica: "Lo que llevas gastado en el periodo elegido.",
    grupo: "principal", familia: "gasto", forma: "dinero", porDefecto: true,
  },
  {
    id: "cpm", base: "Gasto", nombre: "CPM", explica: "Lo que cuesta que el anuncio se muestre 1.000 veces.",
    grupo: "principal", familia: "gasto", forma: "dinero", porDefecto: true,
  },
  {
    id: "cpp", base: "Gasto", nombre: "Coste por 1.000 personas",
  ...
  {
    id: "social_spend", base: "Gasto", nombre: "Gasto en social",
  ...
  {
    id: "full_view_impressions", base: "Alcance", nombre: "Impresiones vistas del todo",
    explica: "Veces que el anuncio se mostró entero, no a medias.",
    grupo: "avanzada", familia: "alcance", forma: "numero",
  },
  {
    id: "full_view_reach", base: "Alcance", nombre: "Personas que lo vieron del todo",
  ...
  {
    id: "cpc", base: "Coste por clic", nombre: "CPC (todos)", explica: "Coste medio de un clic, contando todos los clics.",
  ...
  {
    id: "unique_clicks", base: "Clics", nombre: "Personas que hicieron clic",
    explica: "Personas distintas que hicieron algún clic, del tipo que sea.",
    grupo: "principal", familia: "clics", forma: "numero",
  },
  {
    id: "unique_ctr", base: "CTR", nombre: "CTR por persona",
    explica: "Porcentaje de personas que hicieron algún clic sobre las que vieron el anuncio.",
    grupo: "principal", familia: "clics", forma: "porcentaje",
  },
  {
    id: "cost_per_unique_click", base: "Coste por clic", nombre: "Coste por persona que hace clic",
  ...
  {
    id: "inline_link_click_ctr", base: "CTR", nombre: "CTR del enlace",
    explica: "Porcentaje de clics en el enlace sobre impresiones.",
    grupo: "principal", familia: "clics", forma: "porcentaje",
  },
  {
    id: "cost_per_inline_link_click", base: "Coste por clic", nombre: "Coste por clic en el enlace",
    explica: "Lo que cuesta cada clic en el enlace.",
    grupo: "principal", familia: "clics", forma: "dinero",
  },
  {
    id: "unique_inline_link_clicks", base: "Clics", nombre: "Personas que pulsaron el enlace",
    explica: "Personas distintas que pulsaron el enlace del anuncio.",
    grupo: "principal", familia: "clics", forma: "numero",
  },
  {
    id: "unique_inline_link_click_ctr", base: "CTR", nombre: "CTR del enlace por persona",
    explica: "Porcentaje de personas que pulsaron el enlace sobre las que vieron el anuncio.",
    grupo: "principal", familia: "clics", forma: "porcentaje",
  },
  {
    id: "cost_per_unique_inline_link_click", base: "Coste por clic", nombre: "Coste por persona que pulsa el enlace",
  ...
  },
  {
    ...
    base: "CTR",
    nombre: "CTR de enlace por persona",
    explica:
      "De cada 100 personas que vieron el anuncio, cuántas pulsaron un enlace. Cuenta personas, no pulsaciones.",
    grupo: "principal", familia: "clics", forma: "porcentaje",
  },
  {
    id: "website_ctr", base: "CTR", nombre: "CTR hacia la web",
  ...
  {
    id: "cost_per_action_type", base: "Resultados", nombre: "Coste por resultado",
  ...
  {
    id: "cost_per_conversion", base: "Resultados", nombre: "Coste por conversión",
    explica: "Lo que cuesta cada conversión.",
    grupo: "principal", familia: "conversiones", forma: "lista",
  },
  {
    id: "action_values", base: "Resultados", nombre: "Valor de los resultados",
  ...
  {
    id: "purchase_roas", base: "Resultados", nombre: "ROAS",
    explica: "Cuánto ingresas por cada euro gastado. Vacío hasta que se manden compras a Meta.",
    grupo: "avanzada", familia: "conversiones", forma: "lista",
  },
  {
    id: "website_purchase_roas", base: "Resultados", nombre: "ROAS de la web",
  ...
  // ── VÍDEO ──
  {
    id: "video_play_actions", base: "Vídeo", nombre: "Reproducciones",
    explica: "Veces que se empezó a reproducir el vídeo.",
    grupo: "principal", familia: "video", forma: "lista",
  },
  {
    id: "video_p25_watched_actions", base: "Vídeo", nombre: "Llegaron al 25%",
    explica: "Cuántos vieron al menos la cuarta parte del vídeo.",
    grupo: "principal", familia: "video", forma: "lista",
  },
  {
    id: "video_p50_watched_actions", base: "Vídeo", nombre: "Llegaron a la mitad",
    explica: "Cuántos vieron al menos la mitad. Es el corte que mejor indica si el vídeo engancha.",
    grupo: "principal", familia: "video", forma: "lista",
  },
  {
    id: "video_p75_watched_actions", base: "Vídeo", nombre: "Llegaron al 75%",
    explica: "Cuántos vieron al menos tres cuartas partes.",
    grupo: "principal", familia: "video", forma: "lista",
  },
  {
    id: "video_p100_watched_actions", base: "Vídeo", nombre: "Lo vieron entero",
    explica: "Cuántos llegaron al final del vídeo.",
    grupo: "principal", familia: "video", forma: "lista",
  },
  {
    id: "video_avg_time_watched_actions", base: "Vídeo", nombre: "Tiempo medio visto",
    explica: "Cuántos segundos aguanta la gente de media.",
    grupo: "principal", familia: "video", forma: "lista",
  },
  {
    id: "video_thruplay_watched_actions", base: "Vídeo", nombre: "Reproducciones completas",
    explica: "Vieron el vídeo entero, o al menos 15 segundos si es largo. Es la métrica que Meta usa para cobrar.",
    grupo: "principal", familia: "video", forma: "lista",
  },
  {
    id: "cost_per_thruplay", base: "Vídeo", nombre: "Coste por reproducción completa",
  ...
  // ── CALIDAD ──
  {
    id: "quality_ranking", base: "Calidad", nombre: "Calidad del anuncio",
  ...
  {
    id: "engagement_rate_ranking", base: "Calidad", nombre: "Interacción esperada",
    explica: "Si tu anuncio genera más o menos interacción que la competencia.",
    grupo: "principal", familia: "calidad", forma: "texto",
  },
  {
    id: "conversion_rate_ranking", base: "Calidad", nombre: "Conversión esperada",
    explica: "Si tu anuncio convierte más o menos que la competencia.",
    grupo: "principal", familia: "calidad", forma: "texto",
  },
  {
    id: "estimated_ad_recall_rate", base: "Calidad", nombre: "Recuerdo del anuncio",
  ...
  {
    id: "estimated_ad_recallers", base: "Calidad", nombre: "Personas que lo recordarían",
 ...
 * "CTR: 8 versiones distintas" con la diferencia de cada una al lado.
 */
export function porFamiliaDeVariantes(): { base: string; metricas: Metrica[] }[] {
  ...
  // Las destacadas por Marco primero dentro de cada familia, y las familias con más
  // variantes arriba: son las que de verdad hay que explicar.
  return [...mapa.entries()]
    .map(([base, metricas]) => ({
      base,
      metricas: [...metricas].sort(
