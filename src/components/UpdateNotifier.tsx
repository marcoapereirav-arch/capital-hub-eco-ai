...
export function UpdateNotifier() {
  ...
  return (
    <div
      role="status"
      className="fixed right-4 z-[100] bottom-[calc(3.5rem+var(--sab)+1rem)] md:bottom-6 md:right-6 w-[min(360px,calc(100vw-2rem))] rounded-xl border border-border bg-card p-4 shadow-xl"
    >
