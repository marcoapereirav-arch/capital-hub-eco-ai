    ...
    <>
      ...
      <div className="flex flex-col gap-6 p-4 pb-mobile-nav md:gap-8 md:p-6">
        ...
        <div className="-mx-4 flex items-center gap-2 overflow-x-auto border-b border-border px-4 md:mx-0 md:px-0">
          <div className="flex shrink-0 items-center gap-2 border-b-2 border-foreground px-3 py-2 text-sm font-medium text-foreground">
            Negocio
          </div>
          <div className="flex shrink-0 items-center gap-2 border-b-2 border-transparent px-3 py-2 text-sm text-muted-foreground/60">
