 ...
 *  1. Crear el SOP en knowledges con quadrant='marketing' (si es
...
const SPECIAL_RESOURCE_REDIRECTS: Record<string, string> = {
  // Paginas vivas del OS (no markdown): al clicarlas se abren tal cual.
  brandkit: "/brandkit",
  "reporte-funnel-test-personalidad-v2": "/reportes/funnel-test-personalidad-v2",
}
