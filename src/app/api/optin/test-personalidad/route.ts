 ...
 *
 * Funnel principal de entrada de leads del Capital Hub.
 ...
 *  - Asigna pipeline default + tag 'origen:test_personalidad'
 *  - Anade evento al journey
...
export async function POST(req: Request) {
  ...
  {
    const { data: existing } = await admin.from("contacts").select("id, stage").ilike("email", email).maybeSingle()
