...
const STEPS: Step[] = [
  ...
  {
    id: "manychat",
    title: "ManyChat detecta seguidores",
    subtitle: "Auto-añade leads al CRM",
    icon: MessageSquare,
    status: "wip",
    href: "/crm/pipeline",
    description: "ManyChat capta los nuevos seguidores de Instagram automáticamente y los inserta en la columna 'Nuevo seguidor' del pipeline del CRM. El setter solo gestiona y responde desde el inbox de ManyChat (no se puede desde el OS por restricciones de Meta).",
  },
  {
    id: "agenda",
  ...
  },
  {
    ...
    description: "El sistema genera un token único + manda email Resend brandeado al alumno con link app.capitalhubapp.com/accept-invite/<token>. NO usa los emails de Supabase (BYOE pattern), permite escalar sin límite. Edita el copy de cualquier template desde /email-marketing sin tocar código.",
  },
  {
    id: "app-onboarding",
