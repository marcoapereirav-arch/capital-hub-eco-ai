...
**Asset:** `.Codex/skills/video-visuals/assets/levy.png`
...
```bash
npx tsx .Codex/skills/image-generation/scripts/generate-image.ts \
...
npx tsx .Codex/skills/image-generation/scripts/generate-image.ts \
  --prompt "PROMPT_EN_ESPANOL" \
  --image .Codex/skills/video-visuals/assets/levy.png \
  --output generadas/XX-nombre.png \
  --aspect 16:9
```
