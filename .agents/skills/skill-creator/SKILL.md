...
To create specialized skills that extend Codex's capabilities with domain-specific knowledge and reusable workflows.

## When to Use

- Creating new domain-specific skills
- Building reusable tools for your team
- Extending Codex functionality
...
## When to Use
Explain when Codex should activate this skill.
