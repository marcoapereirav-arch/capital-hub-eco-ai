...
- .Codex/design-systems/ (sistemas de diseno)
- .Codex/skills/ai/references/ (AI templates)
- .Codex/PRPs/ (templates PRP)
...
### Paso 4: Eliminar .Codex/ (auto-destruccion)

Este es el ULTIMO paso porque este skill esta dentro de `.Codex/`:
