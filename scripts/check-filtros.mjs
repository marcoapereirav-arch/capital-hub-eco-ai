...
const EXCEPCIONES = new Set([
  ...
  // Actividad del dashboard: "Hoy" y "Ayer" son la cabecera de cada grupo del feed
  // ("lo que pasó hoy"), no un filtro de periodo. El filtro de esa pantalla es el del OS.
  "src/features/dashboard/components/dashboard-activity.tsx",
